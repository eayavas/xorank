Anladım, kusura bakma. Markdown formatında kod bloğunu kapatırken bir hata oluştuğu için metin düz yazıya dönüşmüş ve bozulmuş.

Aşağıda **README.md** dosyanın **tamamını tek bir parça halinde** paylaşıyorum. Bunu kopyalayıp projenin kök dizinindeki `README.md` dosyasının içine yapıştırabilirsin.
